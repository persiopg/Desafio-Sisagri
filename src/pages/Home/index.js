                        ...
                        <div className="conteudo-mid-tabelas">
                            <div  className="conteudo-mid-talhoes">
                                ...
                                <div className="conteudo-mid-talhoes-tabela">
                                    <ul>
                                        <li><img src={um}/>Abrigo</li>
                                        <li><img src={dois}/>Campo verde</li>
                                        <li><img src={tres}/>Abrigo</li>
                                    </ul>
                                </div>
                            ...
                            <div className="conteudo-mid-safras">
                                ...
                                <ul>
                                        <li><img src={location}/>
                                        Abrigo - Uva Vitoria<br/>
                                        Area 1.2ha - Plantio: 20/04/2022</li>
                                        <li><img src={location}/>
                                        Abrigo - Uva Vitoria<br/>
                                        Area 1.2ha - Plantio: 20/04/2022</li>
                                        <li><img src={location}/>
